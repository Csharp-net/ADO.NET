...
{
    public partial class Fill_OR_Cancel_ORDER_Form : Form
    {
        ...
        public Fill_OR_Cancel_ORDER_Form()
        {
            InitializeComponent();
        }
        ...
        private void btnCancelOrde_Click(object sender, EventArgs e)
        {
            if (IsOrderIDValid())
            {
        ...
        private void btnFinishUpdat_Click(object sender, EventArgs e)
        {
            this.Close();
        }
    }
